...
export default [
    ...
    {name: 'Per Thorsheim', title: 'Sikkerhetssjef og passordekspert', image: 'per_thorsheim.jpg', url: 'https://twitter.com/thorsheim' , bio: 'Lidenskapelig opptatt av folks dårlige passord, som bidro til at han grunnla http://PasswordsCon.org. Jobber til daglig som sikkerhetssjef, men er en dreven foredragsholder som vet å fange oppmerksomheten til de fleste.  Mest kjent for å i 2012 avslørte at Linkedin var blitt hacket, samt i 2015 med datingtjenesten Ashley Madison. Han er sertifisert CISA, CISM, CISSP & ISSAP.'},
    {
        ...
        title: 'Informasjonssikkerhetsansvarlig, Visma',
        image: 'hans_petter_holen.jpg',
        url: 'https://twitter.com/hpholen',
        bio: 'En av grunnleggerne av Oslonett, første tilbyder av Internett for privatpersoner og SMBer i Norge. Har siden hatt lederstillinger i Schibsted Nett, Scandinavia Online og Tascali. Vært aktiv i ICANN og RIPE i over 20 år, i rollen som chair for RIPE de siste 5 årene.'
    },
    {name: 'Håkon Grimstad', title: 'Administrerende Direktør, Norsk Helsenett', image: 'hakon_grimstad.jpg', url: '' , bio: 'Jobbet over 10 år som Administrerende Direktør i Norsk Helsenett.'},
    ...
    {name: 'Marie Moe', title: 'Forskningssjef, SINTEF Digital', image: 'marie_moe.jpg', url: 'https://twitter.com/mariegmoe', bio: 'Marie Moe har en mastergrad i matematikk/kryptografi, samt en doktorgrad i informasjonssikkerhet. Marie har erfaring som seksjonsleder ved NSM NorCERT, Norges nasjonale senter for håndtering av alvorlige dataangrep. Hun jobber i dag som forskningssjef ved SINTEF Digital, og underviser ved NTNU. På fritiden er Marie engasjert i grasrot-organisasjonen ”I Am The Cavalry”.'},
    {name: 'Ravishankar Borgaonkar', title: 'Forsker, SINTEF Digital', image: 'ravishankar_borgaonkar.jpg', url: 'https://twitter.com/raviborgaonkar', bio: 'Gjennomførte sin PhD om sikkerhet i telekommunikasjon ved det tekniske universitetet i Berlin, siden jobbet 3 år som sikkerhetsforsker ved Deutsche Telekom\'s innovasjonslab. Forsker mye sikkerhet, trusler og sårbarheter i kommunikasjonssystemer, med mye fokus mobile systemer, som 2G/3G/4G/5G og sluttbruker enheter som smarttelefoner.'},
    {name: 'Tore Orderløkken', title: 'Sikkerhetsdirektør, Huawei Norge', image: 'tore_orderlokken.jpg', url: 'https://twitter.com/TOrderlokken', bio: 'Har over 20 års erfaring i sikkerhetsbransjen, med erfaring fra Forsvaret, Telenor og NorSIS. Har jobbet 9 år som direktør for NorSIS og 3.5 år som vice president for sikkerhet i EVRY.'},
